...
pos_dev = pos_data_shuffled.loc[int(
    len_pos * training_perc):int(len_pos * (training_perc + dev_perc))]
...
neg_dev = neg_data_shuffled.loc[int(
    len_neg * training_perc):int(len_neg * (training_perc + dev_perc))]
...
result_dir = os.path.join(BASE_DIR, 'corpora/processed/twitter/')
